...
def __extract_primer(primers: list[dict], file: TextIOWrapper, region_name: str, amplicon_name: str) -> None:
    if not primers:
        return None
...
def __write_fasta(data: dict, file: TextIOWrapper):
    for region in data['regions']:
        ...
        for amplicon in region['amplicons']:
            ...
            __extract_primer(amplicon["forward_primers"], file, region_name, amplicon_name)
            __extract_primer(amplicon["reverse_primers"], file, region_name, amplicon_name)
